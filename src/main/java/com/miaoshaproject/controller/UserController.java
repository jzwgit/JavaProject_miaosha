...
public class UserController extends BaseController{
    ...
    public String EncodeByMD5(String str) throws NoSuchAlgorithmException, UnsupportedEncodingException {
        //确定计算方法
        MessageDigest md5 = (MessageDigest) MessageDigest.getInstance("MD5");
    ...
    public CommonRetrunType getOtp(@RequestParam(name="telphone")String telphone){
        ...
        //将otp验证码同对应用户的手机号关联,暂时使用httpSession的方式绑定它的手机号与otpcode
        httpServletRequest.getSession().setAttribute(telphone,optCode);

        //将otp验证码通过短信通道发送给用户,暂省略
